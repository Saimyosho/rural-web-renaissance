      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 text-sm sm:text-base justify-center">
            ...
            {/* CTAs */}
            <motion.div 
              className="flex flex-col sm:flex-row gap-3 max-w-md justify-center"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {/* Quick Stats */}
            <motion.div
              className="pt-4 border-t border-border/50 max-w-md"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
