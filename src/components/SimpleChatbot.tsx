...
const SimpleChatbot = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-gradient-to-br from-slate-950 via-purple-950/50 to-slate-950 border border-purple-500/20 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-xl">
      ...
      <div className="relative bg-gradient-to-r from-purple-900/40 via-indigo-900/40 to-violet-900/40 px-6 py-5 border-b border-purple-500/20 backdrop-blur-sm">
        ...
        <div className="relative flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-amber-400 via-purple-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-purple-500/50 animate-pulse-slow">
            ...
            <div>
              <h3 className="font-bold text-xl bg-gradient-to-r from-amber-200 via-purple-200 to-indigo-200 bg-clip-text text-transparent">
          ...
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-400/30">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4 scrollbar-thin scrollbar-thumb-purple-500/20 scrollbar-track-transparent">
        ...
        {isLoading && (
          <div className="flex justify-start animate-fade-in">
            <div className="bg-gradient-to-br from-slate-800/90 to-slate-900/90 rounded-2xl px-5 py-3.5 border border-purple-500/20 backdrop-blur-sm">
      ...
      <div className="px-6 pb-4">
        <p className="text-xs text-purple-300/70 mb-3 flex items-center gap-1.5 font-medium">
      ...
      <div className="border-t border-purple-500/20 p-5 bg-gradient-to-r from-slate-900/50 via-purple-900/20 to-slate-900/50 backdrop-blur-sm">
        <div className="flex gap-3">
          <div className="flex-1 relative">
            <input
              ...
              disabled={isLoading}
              className="w-full px-5 py-3.5 rounded-xl bg-slate-900/60 border border-purple-500/30 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-400/50 text-sm text-slate-100 placeholder-slate-400 transition-all duration-300 backdrop-blur-sm"
            />
        ...
        <p className="text-xs text-purple-300/60 mt-3 text-center flex items-center justify-center gap-1.5">
