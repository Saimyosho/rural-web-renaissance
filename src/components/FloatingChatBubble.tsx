        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed z-[101] bottom-20 md:bottom-24 right-4 md:right-6 w-[calc(100vw-2rem)] md:w-[400px] h-[600px] md:h-[650px] shadow-2xl"
            >
      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-[100] w-16 h-16 rounded-full bg-gradient-to-br from-amber-500 via-purple-600 to-indigo-600 text-white shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 flex items-center justify-center group overflow-hidden"
